...
void ObstaclesCritic::score(CriticData & data)
{
  ...
  data.costs += xt::pow(combined_cost, power_);
  data.fail_flag = all_trajectories_collide;

  std::cout
    << "[ObstaclesCritic] "
    << "raw_mean=" << xt::mean(raw_cost)()
    << ", raw_max=" << xt::amax(raw_cost)()
    << ", rep_mean=" << xt::mean(repulsive_cost)()
    << ", rep_max=" << xt::amax(repulsive_cost)()
    << ", comb_mean=" << xt::mean(combined_cost)()
    << ", comb_max=" << xt::amax(combined_cost)()
    << ", total_mean=" << xt::mean(data.costs)()
    << ", total_max=" << xt::amax(data.costs)()
    << ", fail_flag=" << (data.fail_flag ? "true" : "false")
    << std::endl;
}

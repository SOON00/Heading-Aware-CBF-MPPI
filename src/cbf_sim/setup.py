...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'footprint_check = cbf_sim.footprint_check:main',
            'collision_checker = cbf_sim.collision_checker:main',
            'data_logger = cbf_sim.data_logger:main',
            'plot = cbf_sim.plot:main',
            'waypoint = cbf_sim.waypoint:main',
        ],
    },
)
